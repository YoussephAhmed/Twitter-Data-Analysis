...
root.geometry("720x1080") #Width x Height
...
canvas1 = tk.Canvas(root, width=400, height=900)
canvas1.pack()
...
keyword = Label(root,
                  text="keyword").place(x = 150,
                                           y = 375)



number = Label(root,
                      text="number").place(x = 150,
                                               y = 405)
